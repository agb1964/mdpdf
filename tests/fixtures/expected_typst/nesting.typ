...
#{
  mdpdf-list(ordered: false, start: 1, items: (mdpdf-task(checked: none, par(text("внешний пункт")) + mdpdf-list(ordered: false, start: 1, items: (mdpdf-task(checked: none, par(text("вложенный пункт")) + mdpdf-list(ordered: true, start: 1, items: (mdpdf-task(checked: none, par(text("нумерованный"))), mdpdf-task(checked: none, par(text("второй")))))),))), mdpdf-task(checked: true, par(text("задача выполнена"))), mdpdf-task(checked: false, par(text("задача не выполнена")))))

  mdpdf-quote(par(text("цитата")) + mdpdf-quote(par(text("вложенная цитата")) + mdpdf-list(ordered: false, start: 1, items: (mdpdf-task(checked: none, par(text("список внутри цитаты"))),))))
}
