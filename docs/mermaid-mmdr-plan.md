...
**Статус:** выполнено 2026-07-31 (фазы 0, A, B, C, D, F). Отложены фаза E
(дальнейшее ужесточение детерминизма шрифтов) и G (полировка доков).
Фактический результат и расхождения с этим планом — в
[`progress.md`](progress.md), подраздел «Миграция на mmdr».

**Дата:** 2026-07-30 (план), 2026-07-31 (исполнение)
