...
> **Статус:** Milestone 0 — каркас. CLI, коды завершения, чтение входа и структура
> модулей на месте; парсер Markdown, генератор Typst и компилятор PDF реализуются
> на Milestone 1–3, поэтому создание PDF пока возвращает ошибку «not implemented».
