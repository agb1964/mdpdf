...
- ребро, направленное в **id подграфа** (`A --> Имя_подграфа`), рисуется
  рамкой вокруг всего подграфа вместо стрелки. Обходится тем, что ребро
  направляют в конкретный узел внутри подграфа;
